...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 mt-4 text-center">
            <form action="{{ route('authentication.postsignup') }}" method="post">
                        ...
                        <div class = "row">
                            ...
                            <div class ="col-10">
                                    <div class="form-group">
                                            <label class="todo-title" for="title">Name</label>
                                        ...
                                        <div class="form-group">
                                            <label class="todo-title" for="title">Confirm Password</label>
