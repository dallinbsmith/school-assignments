            ...
            @foreach($posts as $post)
                <div class='col-md-5 d-inline-block m-3 pt-3 rounded shadow note-card'>
                    <div class = "row">
                        ...
                        <div class ="col-10">
                            <h5 class='mt-2 text-left pr-3 post-title'>{{ $post['title'] }}</h5>   
                                <div class = 'pt-1 pr-3 text-left post-content'>
                                    <p>{{ $post['content'] }}!</p>
                                </div>     
                                <div class = "row mt-4 mb-2">
                                    <p class = "col-3"><a href="{{ route('homepage.single', ['id' => array_search($post, $posts)]) }}"><img src="https://img.icons8.com/ios/60/000000/circled-chevron-down-filled.png"></img></a></p>
                                    <p class = "col-4">
                                        <a href="{{ route('homepage.edit', ['id' => array_search($post, $posts)]) }}">
