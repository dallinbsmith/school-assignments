            ...
            @foreach($todos as $todo)
                <div class='col-md-5 d-inline-block m-3 pt-3 rounded shadow note-card'>
                    <div class = "row">
                        ...
                        <div class ="col-10">
                            <h5 class='mt-2 text-left pr-3 post-title'>{{ $todo['title'] }}</h5>   
                                <div class = 'pt-1 pr-3 text-left post-content'>
                                    <p>{{ $todo['content'] }}!</p>
                                </div>     
                                <div class = "row mt-4 mb-2">
                                    <p class = "col-3"><a href="{{ route('homepage.single', ['id' => array_search($todo, $todos)]) }}"><img src="https://img.icons8.com/ios/60/000000/circled-chevron-down-filled.png"></img></a></p>
                                    <p class = "col-4">
