<nav class="navbar navbar-expand-lg navbar-dark navbar-main">
        ...
        <div class="row pr-5">
            <div class="col-md-12">
                <a href="{{ route('authentication.login') }}" class="btn new-todo-btn">Login</a>
                </div>
            </div>
        <div class="row pr-5">
            <div class="col-md-12">
                <a href="{{ route('authentication.signup') }}" class="btn new-todo-btn">Sign Up</a>
              </div>
          </div>
          <div class="row pr-5">
            <div class="col-md-12">
          ...
          <div class="row pr-5">
            <div class="col-md-12">
                <a href="{{ route('test.authenticated') }}" class="btn new-todo-btn">Testing</a>
              </div>
          </div>
</nav>