                            ...
                            <div class = "row">
                                ...
                                <div class ="col-10">
                                            <div class="form-group">
                                                <label class = "todo-content" for="name">Name</label>
                                                <input type="text" class="form-control form-control-content" value="" name="name" cols="40" rows="5"></input>
                                            </div> 
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class = "todo-content" for="password_confirmation">Confirm Password</label>
                                                <input type="text" class="form-control form-control-content" value="" name="password_confirmation" cols="40" rows="5"></input>
                                            </div> 
