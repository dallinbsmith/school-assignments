                        ...
                        <div class ="col-10">
                            <h5 class='mt-2 text-left pr-3 todo-title'>{{ $todo['title'] }}</h5>   
                                ...
                                <div class = "row mt-4 mb-2 mr-2">
                                    <p class = "col-4"><a href="{{ route('todolist.single', $todo['id']) }}"><img src="https://img.icons8.com/ios/60/000000/circled-chevron-down-filled.png"></img></a></p>
                                    <p class = "col-4">
                                    ...
                                    <p class = "col-4">
                                        <a  href="{{ route('todolist.delete', $todo['id']) }}">
